...
pairs for a directed Graph. These pairs are known as edges, arcs, or lines for an undirected Graph 
and as arrows, directed edges, directed arcs, or directed lines for a directed Graph. The vertices 
may be part of the Graph structure, or may be external entities represented by integer indices or 
references.
...
Adjacency list: 
For every vertex a list of adjacent vertices is stored. 
...
Graph.prototype.removeVertex = function(vertex) {
  ...
  // Use of tilde is same as: if (arr.indexOf(val) === -1)
  if (~index) {
...
graph size (number of vertices): 6
graph relations (number of edges): 7
1
2
3
4
...
Vertex not found
Vertex not found
path from 6 to 1: 6-4-5-1
path from 3 to 5: 3-2-5
graph relations (number of edges): 5
path from 6 to 1: 6-4-3-2-5-1
graph relations (number of edges): 7
path from 6 to 1: 6-4-5-1
graph size (number of vertices): 5
graph relations (number of edges): 4
path from 6 to 1: 6-4-3-2-1
*/
